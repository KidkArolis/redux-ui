  ...
  return function (WrappedComponent) {
    ...
    (function (_Component) {
      ...
      function UI(props, ctx, queue) {
        ...
        _get(Object.getPrototypeOf(UI.prototype), 'constructor', this).call(this, props, ctx, queue);
        ...
        if (key === undefined) {
          this.key = (WrappedComponent.displayName || WrappedComponent.name) + Math.floor(Math.random() * (1 << 30)).toString(16);
        } else {
          this.key = key;
        }
      ...
      _createClass(UI, [{
        ...
        value: function getDefaultUIState(uiState) {
          ...
          Object.keys(state).forEach(function (k) {
            if (typeof state[k] === 'function') {
              state[k] = state[k](_this.props, globalState);
            }
          });
          return state;
        }
          ...
          if (opts.persist !== true) {
            if (window && window.requestAnimationFrame) {
              window.requestAnimationFrame(function () {
                return _this2.props.unmountUI(_this2.uiPath);
              });
            } else {
        ...
        value: function getMergedContextVars() {
          ...
          if (!this.uiVars || !this.uiPath) {
            ...
            Object.keys(state).forEach(function (k) {
              return _this3.uiVars[k] = _this3.uiPath;
            }, this);
          }
        ...
        value: function updateUI(name, value) {
          ...
          var _getMergedContextVars32 = _slicedToArray(_getMergedContextVars3, 1);

          var uiVars = _getMergedContextVars32[0];
